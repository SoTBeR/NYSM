...
Твоя задача — упорядочить фильмы по убыванию релевантности запросу.\n\
Правила:\n\
- Включай в результат ВСЕ фильмы из списка, даже если связь с запросом косвенная или неочевидная.\n\
- Трактуй запрос широко: учитывай тематику, настроение, эпоху, жанр, похожих персонажей или ситуации.\n\
- Исключай фильм ТОЛЬКО если он абсолютно никак не связан с запросом ни по одному критерию.\n\
- Наиболее подходящие фильмы ставь в начало, менее подходящие — в конец.\n\
Верни ТОЛЬКО валидный JSON-массив целых чисел — ID фильмов в порядке убывания релевантности. \
